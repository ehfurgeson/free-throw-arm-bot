# free-throw-arm-bot
Simulated robot arm trained to shoot basketball free throws through reinforcement learning (RL)
...
1. **Custom FetchPickAndPlace-v2 assets**  
   ...
   - Additionally, the envs/fetch_throw_env.py script acts as a wrapper to make this work, and this wrapper also modifies the environment in some other ways specifically for this project, such as pinning the spawn point of the object (the ball in the case of this project) to around the center of the table
